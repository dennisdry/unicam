...
<head>
    ...
    <meta name="keywords" content="analitika, mikroszkópia, szerviz, nagysebességű kamerák, thermo scientific, olympus ">
            ...
            <div class="col-sm-12 col-xs-12 image">
              <?php
               ...
               <?php foreach( $posts as $post): // variable must be called $post (IMPORTANT) ?>
                 ...
                 if (!empty($image)): ?>
                     <img style="max-width: 60%;margin: 0 auto;" class="img-responsive" src="<?php echo $image['url']; ?>" alt="<?php echo $image['alt']; ?>" />
                 <?php endif; ?>
               <?php endforeach; ?>
