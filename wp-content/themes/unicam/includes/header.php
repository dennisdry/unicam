...
<body>
            ...
            <ul class="list-unstyled accordion-list">
              <li class="accordion-item">
                ...
                <span class="icon plus-icon pull-right">
                  <svg viewBox="0 0 24 24"><use xlink:href="#plus-icon"></use></svg>
                </span>
              </li>
              <li class="accordion-item">
                <span class="icon item-icon">
  ...
  <div class="modal fade white-modal" id="mobileContact" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <div class="row">
        ...
        <div class="modal-body">
          <div class="row">
            <div class="col-sm-4 col-xs-4 image">
              <img src="../img/person.png" class="img-responsive" />
              <h2 class="name">
               Teszt Elek
              </h2>
              <h3 class="position">
            ...
            <div class="col-sm-8 col-xs-8 text">
              ...
              <div class="contact">
                <div class="tel">
                  <a href="tel: (30) 879-7483">
                    Tel: (30) 879-7483
                  </a>
                </div>
                <div class="email">
                  <a href="mailto: tesztelek@unicam.hu">
                    E-mail: tesztelek@unicam.hu
                  </a>
                </div>
              </div>
            </div>
            ...
            <div class="sendform container">
              ...
              <form action="" class="product-form">
                ...
                <div class="field">
                  ...
                  <textarea rows="6" class="text" name="text"></textarea>
                </div>
                <div class="field">
                  <input type="submit" class="main-button send-form" name="email" value="Kuldes" />
                </div>
              </form>
            </div>
          </div>
...
<header class="header container-fluid">
    ...
    <div class="row visible-sm visible-xs mobile-header">
      <div class="col-sm-3 col-xs-3 icon menu-icon pull-left" data-toggle="modal" data-target="#mobileMenu">
        <svg style="width:36px;height:36px" viewBox="0 0 24 24">
      ...
      <div class="mobile-search-open dark">
        <form action="" class="mobile-search-form">
          ...
          <input type="submit" class="mobile-search-send" value="Kereses" />
        </form>
      </div>
    </div>
</header>
